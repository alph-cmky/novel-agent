"""Deterministic checks that do not require an LLM call."""
...
def check_draft_hard_gates(
    ...
    *,
    ...
    units = text_units(content.strip())
...
def check_story_integrity(
    ...
    *,
    ...
    These checks intentionally only flag explicit signals. Semantic decisions
    remain the responsibility of Continuity/Editor agents.
    """
    violations: list[str] = []
    findings: list[dict] = []
    plans = scene_plan or []
